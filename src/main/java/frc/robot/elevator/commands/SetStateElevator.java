...
//
//public class SetStateElevator extends Command {
...
//
//    public SetStateElevator(ElevatorConfig.ElevatorState targetState) {
...
//        final var pidOutput = pidController.calculate(mElevator.getVelocity(), targetState.velocity);
//
...
//        if (mElevator.getLowerLimitState()) {
//            mElevator.setDesiredState(ElevatorState.kZero);
//        } else if (mElevator.getUpperLimitState()) {
//            mElevator.setDesiredState(ElevatorState.kHigh);
//        } else {
//            mElevator.setDesiredState(interrupted ? ElevatorState.kUnspecified : targetState);
//        }
...
//        if (mElevator.getLowerLimitState() && profile != null && profile.calculate(time).velocity < 0 && time > 0.25) {
//            System.out.println("[elevator] canceling due to low limit");
//            return true;
//        }
//
//        if (mElevator.getUpperLimitState() && profile != null && profile.calculate(time).velocity > 0 && time > 0.25) {
...
//            new TrapezoidProfile.State(mElevator.getPosition(), mElevator.getVelocity())); //start state
//    }
//}